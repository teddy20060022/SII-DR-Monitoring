...
if file.exists ():
    ...
    try: 
        ...
        cur = con.cursor()
        sql_command = 'insert into USER_DEMO.Monitoring VALUES(\'STC\',\'B\',1,\'OLSS_MFAPPL\',\'{}\',\'{}\',\'{}\',\'{}\',\'{}\',\'{}\',\'Process Complete\')'.format(start_time,status,end_time,elapsed_time,file_name,total_size)
    ...
    try: 
        con = cx_Oracle.connect('USER_DEMO/oracle@192.168.0.101/DB11G')    
        cur = con.cursor()
        sql_command = 'insert into USER_DEMO.Monitoring VALUES(\'STC\',\'B\',1,\'OLSS_MFAPPL\',\'{}\',\'FAILED\',\'NULL\',\'NULL\',\'NULL\',\'NULL\',\'File not found\')'.format(timestampStr1)
        cur.execute(sql_command)
        con.commit()       
        print("value inserted successful") 
