...
if file.exists ():
    ...
    if objstring_start=='None' or objstring_status=='None' or objstring_end=='None' or objstring_elapsed=='None' or objstringfile_name=='None' or objtotal_size=='None':
        try: 
			...
			cur = con.cursor()
            sql_command = 'insert into USER_DEMO.Monitoring VALUES(\'ST3\',\'B\',2,\'OLSS_MFAPPL\',\'{}\',\'{}\',\'{}\',\'{}\',\'{}\',\'{}\',\'Process Not Complete\')'.format(timestampStr1,status,end_time,elapsed_time,file_name,total_size)
        ...
        try:
            ...
            #con = cx_Oracle.connect('monitor/monitor@172.17.30.77/XE')
			cur = con.cursor()
            sql_command = 'insert into USER_DEMO.Monitoring VALUES(\'ST3\',\'B\',1,\'OLSS_MFAPPL\',\'{}\',\'{}\',\'{}\',\'{}\',\'{}\',\'{}\',\'Process Complete\')'.format(start_time,status,end_time,elapsed_time,file_name,total_size)
            cur.execute(sql_command)
            con.commit()       
            print("value inserted successful") 
        except cx_Oracle.DatabaseError as e: 
    ...
    try: 
        ...
        #con = cx_Oracle.connect('monitor/monitor@172.17.30.77/XE')
		cur = con.cursor()
        sql_command = 'insert into USER_DEMO.Monitoring VALUES(\'ST3\',\'B\',3,\'OLSS_MFAPPL\',\'{}\',\'FAILED\',\'NULL\',\'NULL\',\'NULL\',\'NULL\',\'File not found\')'.format(timestampStr1)
        cur.execute(sql_command)
        con.commit()       
        print("value inserted successful") 
    except cx_Oracle.DatabaseError as e: 
