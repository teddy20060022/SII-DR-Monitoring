...
if file.exists ():
    ...
    if objstring_start=='None' or objstring_status=='None' or objstringend_time=='None' or objstring_file_name=='None':
        try: 
            ...
            cur = con.cursor()
            sql_command = 'insert into USER_DEMO.Monitoring VALUES(\'ST3\',\'R\',3,\'OLSS_MFAPPL\',\'{} {}\',\'{}\',\'{} {}\',\'NULL\',\'{}\',\'NULL\',\'Process Not Completed\')'.format(timestampStr2,start_time,status,end_time,file_name)
        ...
        try: 
            ...
            #con = cx_Oracle.connect('monitor/monitor@172.17.30.77/XE')    
            cur = con.cursor()
            sql_command = 'insert into USER_DEMO.Monitoring VALUES(\'ST3\',\'R\',3,\'OLSS_MFAPPL\',\'{} {}\',\'{}\',\'{} {}\',\'NULL\',\'{}\',\'NULL\',\'Process Completed\')'.format(timestampStr2,start_time,status,timestampStr2,end_time,file_name)
            cur.execute(sql_command)          
            con.commit()       
            print("value inserted successful") 
    ...
    try: 
        ...
        #con = cx_Oracle.connect('monitor/monitor@172.17.30.77/XE')    
        cur = con.cursor()
        sql_command = 'insert into USER_DEMO.Monitoring VALUES(\'ST3\',\'R\',3,\'OLSS_MFAPPL\',\'{}\',\'FAILED\',\'NULL\',\'NULL\',\'NULL\',\'NULL\',\'File not found\')'.format(timestampStr1)
        cur.execute(sql_command)                          
        con.commit()       
        print("value inserted successful") 
