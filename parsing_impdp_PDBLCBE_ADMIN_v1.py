...
if file.exists ():
    ...
    try:
        ...
        cur = con.cursor()
        sql_command = 'insert into USER_DEMO.Monitoring VALUES(\'STC\',\'R\',4,\'PDBLCBE_ADMIN\',\'{}\',\'{}\',\'{} {}\',\'NULL\',\'{}\',\'NULL\',\'Process Complete\')'.format(start_time,status,timestampStr2,end_time,file_name)
    ...
    try:
        ...
        #con = cx_Oracle.connect('monitor/monitor@172.17.30.77/XE')
        cur = con.cursor()
        sql_command = 'insert into USER_DEMO.Monitoring VALUES(\'STB\',\'R\',7,\'PDBLCBE_ADMIN\',\'{}\',\'FAILED\',\'NULL\',\'NULL\',\'NULL\',\'NULL\',\'File not found\')'.format(timestampStr1)
        cur.execute(sql_command)
        con.commit()
        print("value inserted successful with file not exist") 
