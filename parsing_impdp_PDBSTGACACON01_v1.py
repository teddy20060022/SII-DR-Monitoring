...
if file.exists ():
    ...
    try:
        ...
        cur = con.cursor()
        sql_command = 'insert into USER_DEMO.Monitoring VALUES(\'STA\',\'R\',2,\'PDBLCBE_ADMIN\',\'{}\',\'{}\',\'{} {}\',\'NULL\',\'{}\',\'NULL\',\'Process Complete\')'.format(start_time,status,timestampStr2,end_time,file_name)
    ...
    try: 
        con = cx_Oracle.connect('USER_DEMO/oracle@192.168.0.101/DB11G')
        cur = con.cursor()
        sql_command = 'insert into USER_DEMO.Monitoring VALUES(\'STA\',\'R\',2,\'PDBLCBE_ADMIN\',\'{}\',\'FAILED\',\'NULL\',\'NULL\',\'NULL\',\'NULL\',\'File not found\')'.format(timestampStr1)
        cur.execute(sql_command)                          
        con.commit()       
        print("value inserted successful") 
