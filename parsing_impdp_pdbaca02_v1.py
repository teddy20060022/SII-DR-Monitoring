...
if file.exists ():  
    ...
    for x3, lines3 in enumerate(data):
        if x3 == index3-1 :
            ...
            print('{} '.format(timestampStr2),end_time)
    ...
    try: 
        sql_command = 'insert into USER_DEMO.Monitoring VALUES(\'ACA\',\'R\',1,\'pdbaca02\',\'{}\',\'{}\',\'{} {}\',\'NULL\',\'{}\',\'NULL\',\'Process Complete\')'.format(start_time,status,timestampStr2,end_time,file_name)
    ...
    try: 
        sql_command = 'insert into USER_DEMO.Monitoring VALUES(\'ACA\',\'R\',4,\'pdbaca02\',\'{}\',\'FAILED\',\'NULL\',\'NULL\',\'NULL\',\'NULL\',\'File not found\')'.format(timestampStr1)
        cur.execute(sql_command)                          
        con.commit()       
