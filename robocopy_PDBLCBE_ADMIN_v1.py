# -*- coding: utf-8 -*-
"""
Created on Tue Sep  3 10:06:40 2019
...
if file.exists ():
    ...
    start_string = 'start data transfer C:\\symscripts\\1_4_1_Transfer.bat PDBLCBE_ADMIN'
    end_string = 'completed C:\\symscripts\\1_4_1_Transfer.bat PDBLCBE_ADMIN'
    flag = index = 0
    for baris in data:
        index+=1
    ...
    for line1 in data1:
    	if stringToMatch1 in line1:
    		...
    		break
    #print(matchedLine1)
    x1 = re.search('\d\d\d\.\d\d\sm|\sg', matchedLine1)
    ukuran=(x1.group())
    ...
    try: 
        ...
        cur = con.cursor()
        sql_command = 'insert into USER_DEMO.Monitoring VALUES(\'STB\',\'C\',1,\'PDBLCBE_ADMIN\',\'{}\',\'{}\',\'{}\',\'{}\',\'{}\',\'{}\',\'Process Completed\')'.format(start_time,status,end_time,search_times,file_name,ukuran)
    ...
    try:
        con = cx_Oracle.connect('USER_DEMO/oracle@192.168.0.101/DB11G')    
        cur = con.cursor()
        sql_command = 'insert into USER_DEMO.Monitoring VALUES(\'STB\',\'C\',1,\'PDBLCBE_ADMIN\',\'{}\',\'FAILED\',\'NULL\',\'NULL\',\'NULL\',\'NULL\',\'File not found\')'.format(timestampStr1)
        cur.execute(sql_command)                          
        con.commit()       
