...
if file.exists ():
    ...
    try: 
        ...
        cur = con.cursor()
        sql_command = 'insert into USER_DEMO.Monitoring VALUES(\'ACA\',\'C\',1,\'pdbaca02\',\'{}\',\'{}\',\'{}\',\'{}\',\'{}\',\'{}\',\'Process Completed\')'.format(start_time,status,end_time,search_times,file_name,ukuran)
    ...
    try:
        con = cx_Oracle.connect('USER_DEMO/oracle@192.168.0.101/DB11G')    
        cur = con.cursor()
        sql_command = 'insert into USER_DEMO.Monitoring VALUES(\'ACA\',\'C\',1,\'pdbaca02\',\'{}\',\'FAILED\',\'NULL\',\'NULL\',\'NULL\',\'NULL\',\'File not found\')'.format(timestampStr1)
        cur.execute(sql_command)                          
        con.commit()       
